...
namespace RoadMap {
    ...
    private:
        ...
        System::Windows::Forms::Panel^ panelCheckpoints;
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void) {
            ...
            this->panelCheckpoints = (gcnew System::Windows::Forms::Panel());
            ...
            // panelCheckpoints
            // 
            this->panelCheckpoints->Location = System::Drawing::Point(31, 159);
            this->panelCheckpoints->Margin = System::Windows::Forms::Padding(4);
            this->panelCheckpoints->Name = L"panelCheckpoints";
            this->panelCheckpoints->Size = System::Drawing::Size(488, 611);
            this->panelCheckpoints->TabIndex = 8;
            // 
            // btnSaveChanges
            // 
            ...
            this->labelSections->Size = System::Drawing::Size(59, 18);
            ...
            this->labelCheckpoints->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->labelCheckpoints->ForeColor = System::Drawing::Color::Black;
            this->labelCheckpoints->Location = System::Drawing::Point(235, 137);
            this->labelCheckpoints->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
            this->labelCheckpoints->Name = L"labelCheckpoints";
            this->labelCheckpoints->Size = System::Drawing::Size(83, 18);
            this->labelCheckpoints->TabIndex = 11;
            this->labelCheckpoints->Text = L"Checkpoints";
            // 
            // titleLabel
            // 
            ...
            this->Controls->Add(this->panelCheckpoints);
...
#pragma endregion
    ...
    private: System::Void ReadAndDisplayXML(String^ filePath) {
        try {
            System::Xml::XmlDocument^ xmlDoc = gcnew System::Xml::XmlDocument();
            xmlDoc->Load(filePath);

            panelCheckpoints->Controls->Clear();
            ...
            for (int i = 0; i < rowNodes->Count; i++) {
                String^ mainSection = rowNodes[i]->Attributes["Section"]->Value;
                String^ mainCheckpoints = rowNodes[i]->Attributes["Checkpoints"]->Value;

                CreateAndDisplayCheckpoints(mainSection, mainCheckpoints, yOffset, xmlDoc, "ROW", i);
                yOffset += 30 * (mainCheckpoints->Split(',')->Length);
            }

            for (int i = 0; i < rowsNodes->Count; i++) {
                String^ additionalSection = rowsNodes[i]->Attributes["Section"]->Value;
                String^ additionalCheckpoints = rowsNodes[i]->Attributes["Checkpoints"]->Value;

                CreateAndDisplayCheckpoints(additionalSection, additionalCheckpoints, yOffset, xmlDoc, "ROWS", i);
                yOffset += 30 * (additionalCheckpoints->Split(',')->Length);
            }

            panelCheckpoints->AutoScroll = true;
            panelCheckpoints->AutoScrollMinSize = System::Drawing::Size(0, yOffset);
    ...
    private: System::Void CreateAndDisplayCheckpoints(String^ section, String^ checkpoints, int yOffset, XmlDocument^ xmlDoc, String^ nodeType, int nodeIndex) {
        Label^ label = gcnew Label();
        label->AutoSize = true;
        label->Location = System::Drawing::Point(12, yOffset);
        label->Text = section;
        panelCheckpoints->Controls->Add(label);
    ...
    private: System::Void btnSaveChanges_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        for each (Control ^ control in panelCheckpoints->Controls) {
    ...
    private: System::Void UpdateProgressLabel() {
